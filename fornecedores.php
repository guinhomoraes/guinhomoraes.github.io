...
<section class="page-title bg-overlay-black-60 parallax" data-jarallax='{"speed": 0.6}' style="background-image: url(images/bg/slide61.jpg);">
  <div class="container">
    <div class="row"> 
      <div class="col-lg-12"> 
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-8">
        <div class="section-title line lef mb-20">
          <h2 class="title">NOSSOS FORNECEDORES</h2>
    ...
    <div class="row mt-40">
      ...
      <div class="col-lg-3 col-sm-6 xs-mb-30">
        <div class="team team-hover team-shadow">
          <div class="team-photo">
            <img class="img-fluid mx-auto" src="images/team/03.jpg" alt=""> 
          </div>    
          <div class="team-description"> 
            <div class="team-info"> 
    ...
    <div class="row">
      <div class="col-md-8">
        <div class="section-title line lef">
          <h3 class="title mb-3">O QUE ELES DIZEM SOBRE NOSSA EMPRESA</h3>
        </div>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-lg-6 sm-mt-50">
        <div class="clients-list clients-border column-3">
          <ul class="list-unstyled">
            <li> 
              <img class="img-fluid d-block mx-auto" src="images/clients/01.png" alt="">
            </li>
            <li> 
              <img class="img-fluid d-block mx-auto" src="images/clients/02.png" alt="">
            </li>
            <li> 
              <img class="img-fluid d-block mx-auto" src="images/clients/03.png" alt="">
            </li>
            <li> 
              <img class="img-fluid d-block mx-auto" src="images/clients/04.png" alt="">
            </li>
            <li> 
              <img class="img-fluid d-block mx-auto" src="images/clients/05.png" alt="">
            </li>
            <li> 
              <img class="img-fluid d-block mx-auto" src="images/clients/06.png" alt="">
            </li>
          </ul>
        </div>
      </div>
