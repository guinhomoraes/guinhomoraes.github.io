  ...
  <div class="container-fluid pos-r">
    <div class="row  full-height">
      <div class="col-lg-6 map-side">
           <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d118361.97424987813!2d-47.96609832466857!3d-22.018524970632168!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94b87726bb9dd181%3A0xd9d7d71505999bc!2zU8OjbyBDYXJsb3MsIFNQ!5e0!3m2!1spt-BR!2sbr!4v1543059609118" width="600" height= "500" frameborder="0" style="border:0" allowfullscreen></iframe>
        </div>       
    </div>
  </div>
  <div class="container">
    <div class="row justify-content-end">
      <div class="col-lg-6"> 
        <div class="contact-3-info mb-5">
          <div class="clearfix">
            <div class="section-title mb-0 mt-0"> 
              <h2 class="title-effect">CONTATO</h2>
            </div>
            ...
            <form id="contactform" role="form" method="post" action="php/contact-form.php">
              <div class="contact-form clearfix">
                ...
                <div class="section-field submit-button">
                  ...
                  <button id="submit" name="submit" type="submit" value="Send" class="button"><span> ENVIAR MENSAGEM </span> <i class="fa fa-paper-plane"></i></button>
                </div>
              </div> 
            </form>
            <div id="ajaxloader" style="display:none"><img class="mx-auto mt-30 mb-30 d-block" src="template/images/pre-loader/loader-02.svg" alt=""></div>
          </div>          
        </div>
      </div>
    </div>
