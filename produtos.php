       ...
       <nav id="menu" class="mega-menu">
        ...
        <div class="menu-bar">
         ...
         <li><a href="index.php">HOME </a> </li>
            ...
            <li class="active"><a href="produtos.php">NOSSOS PRODUTOS</a> </li>
...
<section class="page-title bg-overlay-black-60 parallax" data-jarallax='{"speed": 0.6}' style="background-image: url(images/bg/bg-10.jpg);">
  <div class="container">
    <div class="row"> 
      <div class="col-lg-12"> 
        ...
        <div class="isotope columns-4 popup-gallery">
          <div class="grid-item photography branding">
            <div class="portfolio-item">
              ...
              <div class="portfolio-overlay">
                <h4 class="text-white"> <a href="detalhe_produto.php"> Produto </a> </h4>
              </div>
          ...
          <div class="grid-item illustration">
            <div class="portfolio-item">
              ...
              <a class="popup portfolio-img" href="images/project/04.jpg"><i class="fa fa-arrows-alt"></i></a>
            </div>
          </div>
          <div class="grid-item illustration">
            <div class="portfolio-item">
