       ...
       <nav id="menu" class="mega-menu">
        ...
        <div class="menu-bar">
         ...
         <li><a href="index.php">HOME </a> </li>
            <li class="active"><a href="sobre.php">A EMPRESA</a> 
            </li>
...
<section class="page-title bg-overlay-black-60 parallax" data-jarallax='{"speed": 0.6}' style="background-image: url(images/bg/bg-01.jpg);">
  <div class="container">
    <div class="row"> 
      <div class="col-lg-12"> 
...
<section class="page-section-ptb px-0 pb-0 pt-5">
    <div class="container p-5 txt-p">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 mt-5 mt-md-0">
          <div class="feature-3">
            <div class="feature-3-image">
             <img alt="" src="template/images/about/01.jpg" class="img-fluid">
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="page-section-ptb px-0 pt-0 pb-5">
    <div class="container p-5 txt-p">
      <div class="row d-flex align-items-center">
        <div class="col-lg-6 col-md-6 col-sm-12 order-2 order-md-1 mt-5 mt-md-0">
          <div class="feature-3">
            <div class="feature-3-image">
             <img alt="" src="template/images/about/01.jpg" class="img-fluid">
            </div>
...
<section class="our-sercive1 page-section-ptb">
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
    ...
    <div class="row">
	    <div class="col-lg-4 col-md-4 col-sm-4 xs-mb-30">
	      <div class="feature-text left-icon">
	        ...
	        <div class="feature-info">
	          <h5 class="text-back">Serviço 1</h5>
	    ...
	    <div class="col-lg-4 col-md-4 col-sm-4 xs-mb-30">
	      <div class="feature-text left-icon">
	        ...
	        <div class="feature-info">
	          <h5 class="text-back">Serviço 2</h5>
	    ...
	    <div class="col-lg-4 col-md-4 col-sm-4">
	      <div class="feature-text left-icon">
	        ...
	        <div class="feature-info">
	          <h5 class="text-back">Serviço 3</h5>
    ...
    <div class="row mt-30">
      <div class="col-lg-4 col-md-4 col-sm-4 xs-mb-30">
        <div class="feature-text left-icon">
          ...
          <div class="feature-info">
            <h5 class="text-back">Serviço 4</h5>
            <p>Make a list of your achievements toward your long-term goal and remind yourself that intentions don’t count, only action’s.</p>
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-md-4 col-sm-4 xs-mb-30">
        <div class="feature-text left-icon">
          ...
          <div class="feature-info">
            <h5 class="text-back">Serviço 5</h5>
            <p>Do it today. Remind yourself of someone you know who died suddenly and the fact that there is no guarantee that tomorrow will come</p>
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-md-4 col-sm-4">
        <div class="feature-text left-icon">
          ...
          <div class="feature-info">
            <h5 class="text-back">Serviço 6</h5>
            <p>Use a past defeat as a motivator. Remind yourself you have nowhere to go except up as you have already been at the bottom.</p>
          </div>
        </div>
      </div>
