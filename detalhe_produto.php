...
<section class="page-title bg-overlay-black-60 parallax" data-jarallax='{"speed": 0.6}' style="background-image: url(images/bg/slide63.jpg);">
  <div class="container">
    <div class="row"> 
      <div class="col-lg-12"> 
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-3 sm-mb-30">
        ...
        <div class="sidebar-widget">
           <h6 class="mt-40 mb-20">SOBRE O PRODUTO</h6>
           <p>PREÇO: R$ 0,00</p>
        </div>
      </div>
<!-- ========================== -->
      <div class="col-lg-9">
        <div class="blog-entry mb-50">
          <div class="entry-image clearfix">
              <img class="img-fluid" src="images/bg/bg-10.jpg" alt="">
          </div>
          <div class="blog-detail">
            ...
            <div class="entry-meta mb-10">
              <ul>
                <li><i class="fa fa-folder-open-o"></i> <a href="#"> Categoria</a></li>
